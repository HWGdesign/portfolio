        ...
        <div class='lg:w-4/5 w-full mx-auto text-dark dark:text-white'>
          ...
          <div class='flex flex-wrap -m-2 mx-5'>
            <div class='py-[5px] sm:w-1/2 sm:pr-1 lg:pr-2 w-full'>
              <div class='relative'>
                <label for='name' class='leading-7 text-sm text-dark dark:text-white font-semibold'>
                  Name
                </label>
                <input
                  type='text'
                  id='name'
                  class=' w-full bg-white dark:bg-dark border-grayLt border-2 rounded-md focus:outline-blue focus:border-none  text-base  text-dark py-[5px] px-3 leading-8 transition-colors duration-200 ease-in-out'
                ></input>
              </div>
            </div>
            <div class='py-[5px] sm:w-1/2 sm:pl-1 lg:pl-2 w-full'>
              <div class='relative'>
                <label for='email' class='leading-7 text-sm text-dark dark:text-white font-semibold'>
                  Email
                </label>
                <input
                  type='text'
                  id='email'
                  name='email'
                  class='w-full bg-white dark:bg-dark border-grayLt border-2 focus:outline-blue focus:border-none rounded-md  text-base  text-dark py-[5px] px-3 leading-8 transition-colors duration-200 ease-in-out'
                ></input>
              </div>
            </div>
            <div class='py-[5px] w-full'>
              <div class='relative'>
                <label for='message' class='leading-7 text-sm text-dark dark:text-white font-semibold'>
                  Message
                </label>
                <textarea
                  id='message'
                  name='message'
                  class='w-full bg-white dark:bg-dark border-grayLt border-2 focus:outline-blue focus:border-none rounded-md h-[200px] text-base  text-dark py-[5px] px-3 resize-none leading-6 transition-colors duration-200 ease-in-out'
                ></textarea>
              </div>
            </div>
            ...
            <a href='#home'>
              <div class='group flex items-center gap-[20px] text-md font-semibold text-dark dark:text-white px-2'>
                <div class='hover:scale-105 duration-200 hover:shadow-sm cursor-pointer flex justify-center items-center w-[40px] h-[40px] p-3 rotate-180 bg-white dark:bg-dark dark:bg-dark text-dark dark:text-white border-2 border-grayLt rounded-full '>
