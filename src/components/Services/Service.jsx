...
const WebDevelopmentServices = () => {
  return (
    <div class=' md:w-1/2'>
      <div class='bg-white dark:bg-dark hover:scale-105 duration-200 hover:shadow-sm border border-grayLt p-[15px] m-[25px] rounded-lg relative h-auto w-auto'>
        <div class='  bg-blue text-white p-2 w-[50px] h-[50px] rounded-full absolute top-[-35px] left-0 right-0 m-auto'>
          <Icon.Web />
        </div>
        <h2 class='text-xl text-dark dark:text-white font-bold title-font py-1 flex justify-center pt-[10px]'>{service[0].title}</h2>
  ...
  return (
    <div class=' md:w-1/2'>
      <div class='bg-white dark:bg-dark hover:scale-105 duration-200 hover:shadow-sm border border-grayLt p-[15px] m-[25px] rounded-lg relative h-auto w-auto'>
        ...
        <h2 class='text-xl text-dark dark:text-white font-bold title-font py-1 flex justify-center pt-[10px]'>{service[1].title}</h2>
        <div class='h-[80px] flex items-center justify-center text-center'>
  ...
  return (
    <div class=' md:w-1/2'>
      <div class='bg-white dark:bg-dark hover:scale-105 duration-200 hover:shadow-sm border border-grayLt p-[15px] m-[25px] rounded-lg relative h-auto w-auto'>
        ...
        <h2 class='text-xl text-dark dark:text-white font-bold title-font py-1 flex justify-center pt-[10px]'>{service[2].title}</h2>
        <div class='h-[80px] flex items-center justify-center text-center'>
  ...
  return (
    <div class=' md:w-1/2'>
      <div class='bg-white dark:bg-dark hover:scale-105 duration-200 hover:shadow-sm border border-grayLt p-[15px] m-[25px] rounded-lg relative h-auto w-auto'>
        ...
        <h2 class='text-xl text-dark dark:text-white font-bold title-font py-1 flex justify-center pt-[10px]'>{service[3].title}</h2>
        <div class='h-[80px] flex items-center justify-center text-center'>
